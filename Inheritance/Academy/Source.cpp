...
#define STUDENT_GIVE_PARAMETERS speciality, rating, group
...
public:
	...
	(
		...
		STUDENT_TAKE_PARAMETERS,
		const string& topic
    ):Student(last_name, first_name, age, speciality, group, rating/*HUMAN_GIVE_PARAMETERS, STUDENT_GIVE_PARAMETERS*/),
		topic(topic)
	{
